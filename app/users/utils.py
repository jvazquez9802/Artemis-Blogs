...
def save_picture(form_picture):
    ...
    prev_picture = os.path.join(app.root_path, 'static/profile_pics', current_user.profile_image_file)
...
def save_cover(form_picture):
    ...
    prev_picture = os.path.join(app.root_path, 'static/cover_pics',  current_user.blog[0].cover_image_file)
